...
int EvalRates(realtype *k, realtype *y, NaunetData *u_data) {
    ...
    if (Tgas>=5.0 && Tgas<20.0) { k[10] = 5.710e-11 * exp(-3.220e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[11] = 3.110e-10 * exp(+7.100e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[12] = 4.930e-10 * exp(-9.500e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[13] = 6.080e-10 * exp(+1.080e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[14] = 5.710e-10 * exp(-2.580e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[15] = 2.870e-11 * exp(+3.800e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[16] = 1.700e-10 * exp(+4.400e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[17] = 2.220e-10 * exp(+4.700e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[18] = 1.110e-09 * exp(-3.500e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[19] = 2.460e-10 * exp(-2.265e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[20] = 1.020e-09 * exp(-2.561e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[21] = 1.480e-10 * exp(-5.880e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[22] = 9.320e-09 * exp(-9.460e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[23] = 1.260e-09 * exp(-6.000e-02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[24] = 6.040e-10 * exp(-8.880e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[25] = 1.310e-10 * exp(-1.404e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[26] = 5.580e-10 * exp(-8.270e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[27] = 6.540e-10 * exp(-1.740e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[28] = 4.670e-11 * exp(+8.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[29] = 1.640e-10 * exp(-6.310e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[30] = 8.310e-11 * exp(+9.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[31] = 1.680e-10 * exp(+7.700e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[32] = 2.190e-10 * exp(+7.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[33] = 3.500e-09 * exp(+4.100e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[34] = 5.080e-09 * exp(+8.000e-02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[35] = 3.020e-10 * exp(+1.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[36] = 4.080e-10 * exp(-6.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[37] = 3.060e-10 * exp(-5.900e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[38] = 2.420e-10 * exp(-8.000e-02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[39] = 4.810e-10 * exp(+4.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[40] = 5.390e-10 * exp(-6.000e-02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[41] = 8.020e-10 * exp(-9.000e-02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[42] = 7.500e-10 * exp(+1.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[43] = 5.590e-10 * exp(-2.490e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[44] = 1.030e-09 * exp(+8.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[45] = 7.830e-12 * exp(-2.378e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[46] = 9.480e-12 * exp(-1.466e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[47] = 2.840e-10 * exp(-8.850e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[48] = 4.120e-10 * exp(+5.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[49] = 1.890e-10 * exp(-3.310e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[50] = 7.320e-10 * exp(-3.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[51] = 1.930e-10 * exp(+6.400e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[52] = 2.520e-12 * exp(-1.501e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[53] = 3.880e-12 * exp(-6.510e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[54] = 6.800e-12 * exp(-1.817e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[55] = 1.030e-10 * exp(-9.680e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[56] = 8.640e-11 * exp(+3.800e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[57] = 6.410e-11 * exp(-2.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[58] = 3.020e-10 * exp(+6.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[59] = 1.490e-10 * exp(+9.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[60] = 5.240e-10 * exp(+5.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[61] = 2.020e-10 * exp(-3.550e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[62] = 3.260e-10 * exp(-1.373e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[63] = 4.490e-10 * exp(-2.314e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[64] = 7.090e-10 * exp(-1.688e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[65] = 2.650e-11 * exp(-2.339e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[66] = 7.330e-11 * exp(-1.580e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[67] = 5.940e-10 * exp(-5.460e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[68] = 2.840e-10 * exp(+5.800e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[69] = 1.560e-11 * exp(-3.252e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[70] = 3.480e-10 * exp(-1.936e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[71] = 4.610e-10 * exp(-2.817e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[72] = 4.160e-10 * exp(-1.711e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[73] = 8.350e-12 * exp(-1.711e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[74] = 1.650e-11 * exp(-1.946e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[75] = 8.150e-11 * exp(-1.560e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[76] = 6.820e-10 * exp(-1.034e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[77] = 4.170e-10 * exp(+3.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[78] = 4.820e-11 * exp(+1.010e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[79] = 6.780e-10 * exp(+2.300e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[80] = 5.410e-10 * exp(-8.500e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[81] = 1.410e-10 * exp(+1.050e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[82] = 2.070e-11 * exp(-8.630e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[83] = 2.570e-10 * exp(+5.500e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[84] = 7.490e-10 * exp(-6.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[85] = 2.270e-10 * exp(+8.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[86] = 1.600e-10 * exp(-1.100e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[87] = 3.930e-11 * exp(-2.100e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[88] = 6.640e-10 * exp(-2.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[89] = 5.390e-10 * exp(+4.400e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[90] = 1.310e-10 * exp(-1.800e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[91] = 3.950e-11 * exp(-8.850e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[92] = 2.740e-10 * exp(+3.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[93] = 8.750e-10 * exp(-5.300e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[94] = 1.630e-10 * exp(+1.570e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[95] = 8.010e-11 * exp(+9.400e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[96] = 1.540e-11 * exp(-1.455e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[97] = 1.170e-11 * exp(-5.700e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[98] = 9.470e-11 * exp(-2.373e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[99] = 4.680e-11 * exp(-1.462e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[100] = 3.360e-10 * exp(-1.800e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[101] = 1.090e-10 * exp(+7.800e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[102] = 3.700e-10 * exp(-5.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[103] = 7.830e-12 * exp(-2.022e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[104] = 2.120e-11 * exp(-1.076e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[105] = 3.590e-11 * exp(-2.851e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[106] = 7.790e-11 * exp(-1.967e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[107] = 2.900e-10 * exp(-4.830e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[108] = 1.360e-10 * exp(+1.500e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[109] = 2.070e-10 * exp(+1.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[110] = 1.100e-10 * exp(+2.700e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[111] = 2.840e-10 * exp(+3.800e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[112] = 1.650e-10 * exp(-3.449e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[113] = 9.570e-10 * exp(-2.393e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[114] = 1.900e-10 * exp(-2.627e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[115] = 1.530e-09 * exp(-6.560e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[116] = 1.070e-10 * exp(-3.939e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[117] = 7.850e-11 * exp(-2.969e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[118] = 9.430e-10 * exp(-2.374e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[119] = 6.890e-10 * exp(-1.897e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[120] = 1.530e-10 * exp(-3.038e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[121] = 9.600e-11 * exp(-2.136e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[122] = 9.060e-10 * exp(-6.620e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[123] = 7.700e-10 * exp(-1.700e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[124] = 5.160e-11 * exp(-1.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[125] = 4.360e-11 * exp(-3.110e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[126] = 1.420e-10 * exp(-1.310e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[127] = 8.230e-10 * exp(+1.300e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[128] = 3.740e-11 * exp(-8.590e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[129] = 1.050e-10 * exp(-3.560e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[130] = 9.120e-11 * exp(-3.650e+00 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[131] = 2.930e-10 * exp(-1.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[132] = 7.590e-10 * exp(+5.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[133] = 3.640e-11 * exp(-5.000e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[134] = 1.920e-10 * exp(+7.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[135] = 1.110e-10 * exp(+5.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[136] = 2.770e-10 * exp(+7.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[137] = 6.520e-10 * exp(-9.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[138] = 5.750e-11 * exp(-1.377e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[139] = 7.310e-11 * exp(-5.030e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[140] = 4.280e-11 * exp(-8.550e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[141] = 5.820e-10 * exp(+8.000e-02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[142] = 5.810e-10 * exp(-4.000e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[143] = 1.080e-10 * exp(-2.067e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[144] = 8.740e-11 * exp(-2.513e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[145] = 2.650e-10 * exp(-1.543e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[146] = 5.970e-10 * exp(-4.630e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[147] = 1.400e-10 * exp(-2.474e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[148] = 1.630e-10 * exp(-1.605e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[149] = 1.080e-10 * exp(-1.984e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[150] = 1.200e-10 * exp(-1.052e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[151] = 2.460e-10 * exp(+2.300e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[152] = 1.480e-10 * exp(+4.900e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[153] = 1.110e-10 * exp(-4.660e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[154] = 6.120e-10 * exp(-4.500e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[155] = 2.140e-10 * exp(-8.470e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[156] = 1.630e-10 * exp(-1.305e+02 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[157] = 6.660e-10 * exp(-4.580e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[158] = 4.470e-11 * exp(+2.600e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[159] = 5.640e-11 * exp(-7.200e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[160] = 5.870e-10 * exp(+1.900e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[161] = 3.210e-10 * exp(-3.830e+01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[162] = 2.780e-10 * exp(+4.700e-01 *
        invT); }
        
    if (Tgas>=5.0 && Tgas<20.0) { k[163] = 3.240e-10 * exp(-8.520e+01 *
        invT); }
        
    if (Tgas<9999.0) { k[164] = 1.238e-17 * pow((T32),
        (+5.000e-01))/y[IDX_HI] * nH; }
        
    if (Tgas<9999.0) { k[165] = 3.713e-17 * pow((T32),
        (+5.000e-01))/y[IDX_HI] * nH; }
        
    if (Tgas<9999.0) { k[166] = 2.475e-17 * pow((T32), (+5.000e-01))/(0.5 *
        y[IDX_HI] + 0.5 * y[IDX_DI]) * user_GtoDN; }
        
    if (Tgas<9999.0) { k[167] = 1.650e-22 * pow((T32),
        (+5.000e-01))/y[IDX_DI] * user_GtoDN; }
        
    if (Tgas<9999.0) { k[168] = 3.300e-22 * pow((T32),
        (+5.000e-01))/y[IDX_DI] * user_GtoDN; }
        
    if (Tgas<9999.0) { k[169] = 7.428e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[170] = 5.083e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[171] = 1.948e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[172] = 1.017e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[173] = 1.694e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[174] = 8.472e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[175] = 1.694e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[176] = 8.472e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[177] = 2.541e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[178] = 4.914e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[179] = 4.914e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[180] = 1.948e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[181] = 1.017e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[182] = 1.948e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[183] = 4.236e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[184] = 8.472e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[185] = 1.271e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[186] = 1.271e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[187] = 4.236e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[188] = 8.472e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[189] = 1.101e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[190] = 3.727e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[191] = 7.541e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[192] = 3.727e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[193] = 7.541e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[194] = 1.101e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[195] = 1.355e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[196] = 6.863e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[197] = 1.017e-15 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[198] = 3.474e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[199] = 3.474e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[200] = 9.319e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[201] = 9.319e-16 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[202] = 1.020e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[203] = 4.600e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[204] = 4.600e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[205] = 5.000e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[206] = 2.100e+00 * user_crflux; }
        
    if (Tgas<9999.0) { k[207] = 2.800e+00 * user_crflux; }
        
    if (Tgas<9999.0) { k[208] = 1.000e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[209] = 1.000e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[210] = 1.000e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[211] = 1.000e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[212] = 1.000e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[213] = 2.200e-02 * user_crflux; }
        
    if (Tgas<9999.0) { k[214] = 2.200e-02 * user_crflux; }
        
    if (Tgas<9999.0) { k[215] = 2.200e-02 * user_crflux; }
        
    if (Tgas<9999.0) { k[216] = 2.200e-02 * user_crflux; }
        
    if (Tgas<9999.0) { k[217] = 2.200e-02 * user_crflux; }
        
    if (Tgas<9999.0) { k[218] = 2.200e-02 * user_crflux; }
        
    if (Tgas<9999.0) { k[219] = 3.000e-04 * user_crflux; }
        
    if (Tgas<9999.0) { k[220] = 3.000e-04 * user_crflux; }
        
    if (Tgas<9999.0) { k[221] = 3.000e-04 * user_crflux; }
        
    if (Tgas<9999.0) { k[222] = 3.000e-04 * user_crflux; }
        
    if (Tgas<9999.0) { k[223] = 3.000e-04 * user_crflux; }
        
    if (Tgas<9999.0) { k[224] = 3.000e-04 * user_crflux; }
        
    if (Tgas<9999.0) { k[225] = 9.300e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[226] = 9.300e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[227] = 9.300e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[228] = 9.300e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[229] = 9.300e-01 * user_crflux; }
        
    if (Tgas<9999.0) { k[230] = 1.760e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[231] = 1.760e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[232] = 1.120e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[233] = 1.120e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[234] = 5.000e+00 * user_crflux; }
        
    if (Tgas<9999.0) { k[235] = 5.000e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[236] = 5.000e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[237] = 4.820e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[238] = 4.940e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[239] = 7.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[240] = 1.170e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[241] = 5.100e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[242] = 5.100e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[243] = 5.000e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[244] = 5.000e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[245] = 1.000e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[246] = 1.120e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[247] = 7.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[248] = 7.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[249] = 5.000e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[250] = 5.000e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[251] = 5.000e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[252] = 1.710e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[253] = 9.700e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[254] = 9.700e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[255] = 9.700e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[256] = 9.700e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[257] = 3.120e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[258] = 3.120e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[259] = 4.210e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[260] = 4.210e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[261] = 1.170e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[262] = 1.170e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[263] = 3.000e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[264] = 3.000e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[265] = 1.000e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[266] = 1.000e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[267] = 1.500e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[268] = 8.000e+01 * user_crflux; }
        
    if (Tgas<9999.0) { k[269] = 8.000e+01 * user_crflux; }
        
    if (Tgas<9999.0) { k[270] = 8.000e+01 * user_crflux; }
        
    if (Tgas<9999.0) { k[271] = 8.000e+01 * user_crflux; }
        
    if (Tgas<9999.0) { k[272] = 6.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[273] = 6.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[274] = 6.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[275] = 1.500e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[276] = 7.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[277] = 7.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[278] = 7.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[279] = 7.500e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[280] = 1.500e+03 * user_crflux; }
        
    if (Tgas<9999.0) { k[281] = 2.370e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[282] = 7.300e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[283] = 7.300e+02 * user_crflux; }
        
    if (Tgas<9999.0) { k[284] = 1.060e+04 * user_crflux; }
        
    if (Tgas<9999.0) { k[285] = 5.000e+00 * user_crflux; }
        
    if (Tgas<9999.0) { k[286] = 3.000e+00 * user_crflux; }
        
    if (Tgas<9999.0) { k[287] = 1.000e-11 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[288] = 4.600e-12 * exp(-3.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[289] = 4.600e-12 * exp(-3.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[290] = 2.600e-10 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[291] = 2.600e-10 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[292] = 2.600e-10 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[293] = 2.600e-10 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[294] = 2.600e-10 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[295] = 2.600e-10 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[296] = 7.200e-12 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[297] = 7.200e-12 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[298] = 1.000e-11 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[299] = 1.000e-11 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[300] = 1.700e-09 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[301] = 1.700e-09 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[302] = 1.700e-09 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[303] = 1.700e-09 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[304] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[305] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[306] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[307] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[308] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[309] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[310] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[311] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[312] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[313] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[314] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[315] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[316] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[317] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[318] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[319] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[320] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[321] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[322] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[323] = 2.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[324] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[325] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[326] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[327] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[328] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[329] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[330] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[331] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[332] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[333] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[334] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[335] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[336] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[337] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[338] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[339] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[340] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[341] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[342] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[343] = 7.900e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[344] = 2.400e-07 * exp(-9.000e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[345] = 2.400e-07 * exp(-9.000e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[346] = 2.400e-07 * exp(-9.000e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[347] = 2.400e-07 * exp(-9.000e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[348] = 2.400e-07 * exp(-9.000e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[349] = 2.400e-07 * exp(-9.000e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[350] = 2.400e-07 * exp(-9.000e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[351] = 2.160e-10 * exp(-2.610e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[352] = 4.700e-11 * exp(-2.600e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[353] = 1.000e-10 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[354] = 1.400e-10 * exp(-1.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[355] = 1.400e-10 * exp(-1.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[356] = 2.900e-10 * exp(-2.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[357] = 2.900e-10 * exp(-2.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[358] = 1.000e-09 * exp(-2.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[359] = 3.100e-11 * exp(-2.540e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[360] = 3.400e-11 * exp(-2.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[361] = 3.400e-11 * exp(-2.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[362] = 3.400e-11 * exp(-2.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[363] = 3.400e-11 * exp(-2.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[364] = 3.400e-11 * exp(-2.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[365] = 5.000e-12 * exp(-3.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[366] = 4.000e-10 * exp(-1.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[367] = 4.000e-10 * exp(-1.500e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[368] = 1.000e-11 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[369] = 1.000e-11 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[370] = 3.000e-10 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[371] = 2.000e-10 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[372] = 3.300e-10 * exp(-1.400e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[373] = 6.200e-12 * exp(-3.100e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[374] = 1.680e-10 * exp(-1.660e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[375] = 1.680e-10 * exp(-1.660e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[376] = 1.600e-12 * exp(-3.100e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[377] = 1.600e-12 * exp(-3.100e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[378] = 1.000e-09 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[379] = 1.000e-09 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[380] = 1.000e-11 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[381] = 1.000e-11 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[382] = 1.000e-10 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[383] = 1.000e-09 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[384] = 2.600e-10 * exp(-2.280e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[385] = 5.000e-11 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[386] = 5.000e-11 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[387] = 5.000e-11 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[388] = 5.000e-11 * exp(-1.700e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[389] = 1.000e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[390] = 1.000e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[391] = 1.000e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[392] = 3.130e-10 * exp(-2.030e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[393] = 3.280e-10 * exp(-1.630e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[394] = 3.280e-10 * exp(-1.630e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[395] = 3.280e-10 * exp(-1.630e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[396] = 3.280e-10 * exp(-1.630e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[397] = 2.100e-11 * exp(-3.100e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[398] = 2.100e-11 * exp(-3.100e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[399] = 2.100e-11 * exp(-3.100e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[400] = 5.480e-10 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[401] = 5.480e-10 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[402] = 5.870e-10 * exp(-5.300e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[403] = 5.870e-10 * exp(-5.300e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[404] = 2.460e-10 * exp(-2.110e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[405] = 2.460e-10 * exp(-2.110e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[406] = 5.480e-10 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[407] = 5.480e-10 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[408] = 1.700e-10 * exp(-5.300e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[409] = 1.700e-10 * exp(-5.300e-01 * user_Av); }
        
    if (Tgas<9999.0) { k[410] = 2.110e-10 * exp(-1.520e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[411] = 2.110e-10 * exp(-1.520e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[412] = 2.110e-10 * exp(-1.520e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[413] = 2.110e-10 * exp(-1.520e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[414] = 1.730e-10 * exp(-2.590e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[415] = 1.730e-10 * exp(-2.590e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[416] = 1.730e-10 * exp(-2.590e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[417] = 1.290e-09 * exp(-2.000e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[418] = 1.000e-11 * exp(-2.000e+00 * user_Av); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[534] = 1.500e-11 * exp(-2.000e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[535] = 4.050e-10 * pow((T32),
        (-1.430e+00)) * exp(-3.500e+03 * invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[536] = 5.000e-12 * exp(-9.000e+02 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[553] = 1.000e-11 * exp(-1.000e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[554] = 1.000e-11 * exp(-1.000e+03 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[557] = 2.810e-13 * exp(-1.760e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[558] = 2.810e-13 * exp(-1.760e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[559] = 3.320e-12 * exp(-6.170e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[560] = 3.320e-12 * exp(-6.170e+03 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[576] = 8.000e-11 * exp(-5.000e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[577] = 8.000e-11 * exp(-5.000e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[578] = 8.000e-11 * exp(-5.000e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[579] = 8.000e-11 * exp(-5.000e+02 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1034] = 2.690e-12 * exp(-2.360e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1035] = 2.690e-12 * exp(-2.360e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1036] = 2.690e-12 * exp(-2.360e+04 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1041] = 9.610e-13 * exp(-1.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1042] = 9.610e-13 * exp(-1.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1043] = 9.610e-13 * exp(-1.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1044] = 9.610e-13 * exp(-1.050e+04 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1053] = 4.980e-10 * exp(-1.810e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1054] = 8.700e-11 * exp(-2.260e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1055] = 1.000e-10 * exp(-5.280e+04 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1060] = 6.610e-11 * exp(-5.160e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1061] = 6.610e-11 * exp(-5.160e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1062] = 6.610e-11 * exp(-5.160e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1063] = 6.610e-11 * exp(-5.160e+04 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1092] = 6.190e-10 * exp(-1.250e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1093] = 6.190e-10 * exp(-1.250e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1094] = 6.190e-10 * exp(-1.250e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1095] = 6.190e-10 * exp(-1.250e+04 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1098] = 3.600e-10 * exp(-2.490e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1099] = 3.600e-10 * exp(-2.490e+04 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1110] = 2.940e-10 * exp(-8.380e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1111] = 2.940e-10 * exp(-8.380e+03 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1124] = 2.510e-10 * exp(-1.330e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1125] = 2.510e-10 * exp(-1.330e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1126] = 9.220e-14 * exp(-2.990e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1127] = 9.220e-14 * exp(-2.990e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1128] = 4.000e-10 * exp(-3.400e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1129] = 4.000e-10 * exp(-3.400e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1130] = 6.640e-10 * exp(-1.170e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1131] = 6.640e-10 * exp(-1.170e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1132] = 6.640e-10 * exp(-1.170e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1133] = 6.640e-10 * exp(-1.170e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1134] = 3.320e-10 * exp(-1.170e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1135] = 3.320e-10 * exp(-1.170e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1136] = 3.750e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1137] = 3.750e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1138] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1139] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1140] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1141] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1142] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1143] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1144] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1145] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1146] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1147] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1148] = 3.750e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1149] = 3.750e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1150] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1151] = 1.875e-10 * exp(-1.660e+03 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1158] = 8.400e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1159] = 8.400e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1160] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1161] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1162] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1163] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1164] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1165] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1166] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1167] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1168] = 8.400e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1169] = 8.400e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1170] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1171] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1172] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1173] = 4.200e-13 * exp(-1.040e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1174] = 4.650e-10 * exp(-1.660e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1175] = 4.650e-10 * exp(-1.660e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1176] = 4.650e-10 * exp(-1.660e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1177] = 4.650e-10 * exp(-1.660e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1178] = 2.325e-10 * exp(-1.660e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1179] = 2.325e-10 * exp(-1.660e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1180] = 5.960e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1181] = 5.960e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1182] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1183] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1184] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1185] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1186] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1187] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1188] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1189] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1190] = 5.960e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1191] = 5.960e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1192] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1193] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1194] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1195] = 2.980e-11 * exp(-7.780e+03 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1205] = 1.500e-11 * exp(-3.680e+03 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[1636] = 1.000e-09 * exp(-8.500e+01 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1637] = 1.000e-09 * exp(-8.500e+01 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1638] = 1.000e-09 * exp(-8.500e+01 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1639] = 1.000e-09 * exp(-8.500e+01 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1640] = 5.000e-10 * exp(-8.500e+01 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[1641] = 5.000e-10 * exp(-8.500e+01 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<280.0) { k[2185] = 7.000e-10 * exp(-2.320e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<280.0) { k[2186] = 7.000e-10 * exp(-2.320e+02 *
        invT); }
    ...
    if (Tgas<9999.0) { k[2851] = 2.100e-09 * exp(-4.050e+02 * invT); }
        
    if (Tgas<9999.0) { k[2852] = 2.100e-09 * exp(-4.910e+02 * invT); }
        
    if (Tgas<9999.0) { k[2853] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2854] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2855] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2856] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2857] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2858] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2859] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2860] = 1.000e-09 * exp(-6.000e+02 * invT); }
        
    if (Tgas<9999.0) { k[2861] = 1.000e-09 * exp(-4.633e+02 * invT); }
        
    if (Tgas<9999.0) { k[2862] = 1.000e-09 * exp(-5.135e+02 * invT); }
        
    if (Tgas<9999.0) { k[2863] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2864] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2865] = 1.000e-09 * exp(-4.300e+02 * invT); }
        
    if (Tgas<9999.0) { k[2866] = 1.000e-09 * exp(-4.720e+02 * invT); }
        
    if (Tgas<9999.0) { k[2867] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2868] = 0.500e-09; }
        
    if (Tgas<9999.0) { k[2869] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2870] = 1.000e-09 * exp(-6.600e+02 * invT); }
        
    if (Tgas<9999.0) { k[2871] = 1.000e-09 * exp(-6.550e+02 * invT); }
        
    if (Tgas<9999.0) { k[2872] = 1.980e-09 * exp(-8.600e+01 * invT); }
        
    if (Tgas<9999.0) { k[2873] = 1.320e-09; }
        
    if (Tgas<9999.0) { k[2874] = 2.200e-10; }
        
    if (Tgas<9999.0) { k[2875] = 1.980e-09 * exp(-1.705e+02 * invT); }
        
    if (Tgas<9999.0) { k[2876] = 7.000e-10; }
        
    if (Tgas<9999.0) { k[2877] = 1.400e-09; }
        
    if (Tgas<9999.0) { k[2878] = 1.400e-09; }
        
    if (Tgas<9999.0) { k[2879] = 2.100e-09; }
        
    if (Tgas<9999.0) { k[2880] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2881] = 1.000e-09 * exp(-4.100e+01 * invT); }
        
    if (Tgas<9999.0) { k[2882] = 2.100e-09; }
        
    if (Tgas<9999.0) { k[2883] = 2.100e-09; }
        
    if (Tgas<9999.0) { k[2884] = 1.000e-09 * exp(-4.640e+02 * invT); }
        
    if (Tgas<9999.0) { k[2885] = 1.000e-09 * exp(-6.345e+02 * invT); }
        
    if (Tgas<9999.0) { k[2886] = 1.050e-09; }
        
    if (Tgas<9999.0) { k[2887] = 5.250e-09; }
        
    if (Tgas<9999.0) { k[2888] = 1.050e-09; }
        
    if (Tgas<9999.0) { k[2889] = 5.250e-10; }
        
    if (Tgas<9999.0) { k[2890] = 0.660e-09; }
        
    if (Tgas<9999.0) { k[2891] = 0.330e-09; }
        
    if (Tgas<9999.0) { k[2892] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2893] = 1.000e-09 * exp(-6.320e+02 * invT); }
        
    if (Tgas<9999.0) { k[2894] = 0.500e-09 * exp(-5.784e+02 * invT); }
        
    if (Tgas<9999.0) { k[2895] = 0.500e-09 * exp(-5.455e+02 * invT); }
        
    if (Tgas<9999.0) { k[2896] = 7.000e-18 * pow((T32), (+1.800e+00)) *
        exp(-1.000e-99 * invT); }
        
    if (Tgas<9999.0) { k[2897] = 1.200e-17 * pow((T32), (+1.800e+00)) *
        exp(-1.000e-99 * invT); }
        
    if (Tgas<9999.0) { k[2898] = 1.000e-09 * exp(-1.540e+02 * invT); }
        
    if (Tgas<9999.0) { k[2899] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2900] = 1.450e-11 * exp(+6.900e-01 * invT); }
        
    if (Tgas<9999.0) { k[2901] = 4.090e-11 * exp(+7.100e-01 * invT); }
        
    if (Tgas<9999.0) { k[2902] = 1.690e-09 * exp(-5.230e+01 * invT); }
        
    if (Tgas<9999.0) { k[2903] = 1.480e-11 * exp(+6.200e-01 * invT); }
        
    if (Tgas<9999.0) { k[2904] = 1.690e-11 * exp(+6.400e-01 * invT); }
        
    if (Tgas<9999.0) { k[2905] = 6.870e-11 * exp(+8.500e-01 * invT); }
        
    if (Tgas<9999.0) { k[2906] = 7.440e-11 * exp(-1.100e-01 * invT); }
        
    if (Tgas<9999.0) { k[2907] = 8.940e-11 * exp(+1.000e+00 * invT); }
        
    if (Tgas<9999.0) { k[2908] = 8.370e-11 * exp(+6.100e-01 * invT); }
        
    if (Tgas<9999.0) { k[2909] = 4.490e-11 * exp(+2.300e-01 * invT); }
        
    if (Tgas<9999.0) { k[2910] = 4.000e-10 * exp(-2.170e+01 * invT); }
        
    if (Tgas<9999.0) { k[2911] = 5.340e-10 * exp(-6.890e+01 * invT); }
        
    if (Tgas<9999.0) { k[2912] = 6.000e-10; }
        
    if (Tgas<9999.0) { k[2913] = 6.500e-10; }
    ...
    if (Tgas<9999.0) { k[2916] = 2.070e-16 * user_GtoDN; }
        
    if (Tgas<9999.0) { k[2917] = 1.048e-16 * user_GtoDN; }
        
    if (Tgas<9999.0) { k[2918] = 4.900e-17 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[2919] = 4.700e-17 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[2920] = 4.400e-17 * pow((T32), (+5.000e-01)) *
        user_GtoDN; }
        
    if (Tgas<9999.0) { k[2921] = 5.000e-10; }
        
    if (Tgas<9999.0) { k[2922] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2923] = 9.000e-10; }
        
    if (Tgas<9999.0) { k[2924] = 1.800e-09; }
        
    if (Tgas<9999.0) { k[2925] = 1.125e-10; }
        
    if (Tgas<9999.0) { k[2926] = 2.250e-10; }
        
    if (Tgas<9999.0) { k[2927] = 1.600e-10; }
        
    if (Tgas<9999.0) { k[2928] = 3.200e-10; }
        
    if (Tgas<9999.0) { k[2929] = 5.083e-15 * pow((T32), (+5.000e-01)); }
        
    if (Tgas<9999.0) { k[2930] = 4.200e-10; }
        
    if (Tgas<9999.0) { k[2931] = 7.000e-09; }
        
    if (Tgas<9999.0) { k[2932] = 4.200e-10; }
        
    if (Tgas<9999.0) { k[2933] = 7.000e-10; }
        
    if (Tgas<9999.0) { k[2934] = 7.000e-10; }
        
    if (Tgas<9999.0) { k[2935] = 2.100e-09; }
        
    if (Tgas<9999.0) { k[2936] = 2.210e-10 * exp(-3.792e+02 * invT); }
        
    if (Tgas<9999.0) { k[2937] = 1.770e-09 * exp(-2.252e+02 * invT); }
        
    if (Tgas<9999.0) { k[2938] = 3.000e-10 * exp(-2.867e+02 * invT); }
        
    if (Tgas<9999.0) { k[2939] = 2.770e-10 * exp(-2.297e+02 * invT); }
        
    if (Tgas<9999.0) { k[2940] = 2.240e-10 * exp(-1.448e+02 * invT); }
        
    if (Tgas<9999.0) { k[2941] = 1.500e-10 * exp(-1.820e+02 * invT); }
        
    if (Tgas<9999.0) { k[2942] = 7.750e-10; }
        
    if (Tgas<9999.0) { k[2943] = 9.160e-11 * exp(-1.550e+01 * invT); }
        
    if (Tgas<9999.0) { k[2944] = 4.610e-10 * exp(+2.900e-01 * invT); }
        
    if (Tgas<9999.0) { k[2945] = 4.750e-10 * exp(-5.400e-01 * invT); }
        
    if (Tgas<9999.0) { k[2946] = 6.180e-10 * exp(+7.700e-01 * invT); }
        
    if (Tgas<9999.0) { k[2947] = 5.370e-11 * exp(-1.520e+01 * invT); }
        
    if (Tgas<9999.0) { k[2948] = 2.510e-11 * exp(-9.950e+01 * invT); }
        
    if (Tgas<9999.0) { k[2949] = 7.740e-11 * exp(-1.530e+01 * invT); }
        
    if (Tgas<9999.0) { k[2950] = 3.333e-10; }
        
    if (Tgas<9999.0) { k[2951] = 5.000e-10; }
        
    if (Tgas<9999.0) { k[2952] = 6.000e-10; }
        
    if (Tgas<9999.0) { k[2953] = 9.000e-10; }
        
    if (Tgas<9999.0) { k[2954] = 7.500e-11; }
        
    if (Tgas<9999.0) { k[2955] = 1.125e-10; }
        
    if (Tgas<9999.0) { k[2956] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2957] = 1.000e-09; }
        
    if (Tgas<9999.0) { k[2958] = 1.000e-17; }
        
    if (Tgas<9999.0) { k[2959] = 4.270e-10 * pow((T32), (-2.100e-01)); }
        
    if (Tgas<9999.0) { k[2960] = 4.270e-10 * pow((T32), (-2.100e-01)); }
        
    if (Tgas<9999.0) { k[2961] = 9.000e-10; }
        
    if (Tgas<9999.0) { k[2962] = 9.000e-10; }
        
    if (Tgas<9999.0) { k[2963] = 4.250e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2964] = 4.250e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2965] = 4.050e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2966] = 4.050e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2967] = 6.000e-10; }
        
    if (Tgas<9999.0) { k[2968] = 8.050e-10; }
        
    if (Tgas<9999.0) { k[2969] = 8.050e-10; }
        
    if (Tgas<9999.0) { k[2970] = 6.500e-10; }
        
    if (Tgas<9999.0) { k[2971] = 3.750e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2972] = 3.750e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2973] = 4.250e-10 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2974] = 4.250e-10 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2975] = 3.200e-10; }
        
    if (Tgas<9999.0) { k[2976] = 3.200e-10; }
        
    if (Tgas<9999.0) { k[2977] = 4.750e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2978] = 4.750e-09 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2979] = 3.640e-10 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2980] = 3.640e-10 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2981] = 1.067e-10; }
        
    if (Tgas<9999.0) { k[2982] = 1.600e-10; }
        
    if (Tgas<9999.0) { k[2983] = 1.150e-07 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2984] = 1.150e-07 * pow((T32), (-5.000e-01)); }
        
    if (Tgas<9999.0) { k[2985] = 1.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[2986] = 1.000e-08 * exp(-1.800e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[2987] = 3.950e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas<9999.0) { k[2988] = 3.950e-09 * exp(-2.300e+00 * user_Av); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[2989] = 4.660e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[2990] = 4.660e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[2995] = 3.210e-01 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[2996] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[2999] = 1.000e+00 * 9.850e-10 *
        (0.62e0 + 0.4767e0 * 4.400e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3000] = 1.000e+00 * 8.210e-10 *
        (0.62e0 + 0.4767e0 * 5.500e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3001] = 1.000e+00 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3002] = 3.330e-01 * 1.120e-09 *
        (0.62e0 + 0.4767e0 * 3.580e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3003] = 8.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3004] = 2.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3005] = 6.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3006] = 3.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3007] = 1.000e+00 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3008] = 1.000e+00 * 8.220e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3009] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[3010] = 2.500e-12; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[3011] = 7.500e-12 * exp(-1.700e+02 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3012] = 1.000e+00 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3013] = 1.430e-01 * 1.010e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3014] = 4.620e-01 * 9.710e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3015] = 4.640e-01 * 9.390e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3016] = 9.250e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[3021] = 1.520e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3022] = 4.570e-10 * exp(-2.070e+04 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[3031] = 3.500e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3032] = 1.170e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3033] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3034] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3035] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3036] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3037] = 3.500e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3038] = 3.500e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3039] = 1.170e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3040] = 1.170e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3041] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3042] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3043] = 1.170e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3044] = 1.170e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3045] = 3.500e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3046] = 3.500e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3047] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3048] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3049] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3050] = 2.330e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3051] = 1.170e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3052] = 3.500e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3053] = 4.660e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3054] = 4.660e-01 * 2.070e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[3114] = 3.210e-01 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3115] = 3.210e-01 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3116] = 3.210e-01 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3117] = 3.210e-01 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3118] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3119] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3120] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3121] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3122] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[3147] = 1.000e+00 * 9.850e-10 *
        (0.62e0 + 0.4767e0 * 4.400e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3148] = 1.000e+00 * 9.850e-10 *
        (0.62e0 + 0.4767e0 * 4.400e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3149] = 1.000e+00 * 9.850e-10 *
        (0.62e0 + 0.4767e0 * 4.400e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3150] = 1.000e+00 * 9.850e-10 *
        (0.62e0 + 0.4767e0 * 4.400e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3151] = 1.000e+00 * 9.850e-10 *
        (0.62e0 + 0.4767e0 * 4.400e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3152] = 1.000e+00 * 8.210e-10 *
        (0.62e0 + 0.4767e0 * 5.500e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3153] = 1.000e+00 * 8.210e-10 *
        (0.62e0 + 0.4767e0 * 5.500e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3154] = 1.000e+00 * 8.210e-10 *
        (0.62e0 + 0.4767e0 * 5.500e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3155] = 1.000e+00 * 8.210e-10 *
        (0.62e0 + 0.4767e0 * 5.500e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3156] = 1.000e+00 * 8.210e-10 *
        (0.62e0 + 0.4767e0 * 5.500e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3157] = 7.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3158] = 2.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3159] = 5.000e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3160] = 5.000e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3161] = 7.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3162] = 2.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3163] = 5.000e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3164] = 5.000e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3165] = 2.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3166] = 7.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3167] = 5.000e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3168] = 5.000e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3169] = 2.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3170] = 7.500e-01 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3171] = 1.000e+00 * 9.260e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3172] = 3.330e-01 * 1.120e-09 *
        (0.62e0 + 0.4767e0 * 3.580e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3173] = 3.330e-01 * 1.120e-09 *
        (0.62e0 + 0.4767e0 * 3.580e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3174] = 3.330e-01 * 1.120e-09 *
        (0.62e0 + 0.4767e0 * 3.580e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3175] = 3.330e-01 * 1.120e-09 *
        (0.62e0 + 0.4767e0 * 3.580e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3176] = 3.330e-01 * 1.120e-09 *
        (0.62e0 + 0.4767e0 * 3.580e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3177] = 1.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3178] = 4.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3179] = 2.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3180] = 3.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3181] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3182] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3183] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3184] = 2.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3185] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3186] = 2.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3187] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3188] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3189] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3190] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3191] = 1.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3192] = 1.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3193] = 1.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3194] = 1.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3195] = 1.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3196] = 1.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3197] = 2.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3198] = 2.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3199] = 2.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3200] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3201] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3202] = 5.000e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3203] = 5.000e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3204] = 7.500e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3205] = 5.250e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3206] = 2.250e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3207] = 3.750e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3208] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3209] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3210] = 1.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3211] = 1.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3212] = 5.000e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3213] = 2.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3214] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3215] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3216] = 3.330e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3217] = 6.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3218] = 3.330e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3219] = 6.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3220] = 2.500e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3221] = 7.500e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3222] = 2.500e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3223] = 7.500e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3224] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3225] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3226] = 1.330e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3227] = 1.670e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3228] = 2.330e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3229] = 6.670e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3230] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3231] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3232] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3233] = 5.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3234] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3235] = 2.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3236] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3237] = 3.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3238] = 2.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3239] = 1.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3240] = 1.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3241] = 3.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3242] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3243] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3244] = 5.000e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3245] = 5.000e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3246] = 5.000e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3247] = 5.000e-02 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3248] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3249] = 1.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3250] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3251] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3252] = 1.830e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3253] = 1.170e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3254] = 1.170e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3255] = 1.830e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3256] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3257] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3258] = 3.170e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3259] = 2.830e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3260] = 4.170e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3261] = 1.830e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3262] = 5.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3263] = 4.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3264] = 2.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3265] = 7.500e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3266] = 4.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3267] = 6.000e-01 * 1.730e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3268] = 1.000e+00 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3269] = 1.000e+00 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3270] = 1.000e+00 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3271] = 1.000e+00 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3272] = 1.000e+00 * 8.450e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3273] = 1.000e+00 * 8.220e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3274] = 1.000e+00 * 8.220e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3275] = 1.000e+00 * 8.220e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3276] = 1.000e+00 * 8.220e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3277] = 1.000e+00 * 8.220e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3278] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3279] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3280] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3281] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3282] = 1.000e+00 * 8.340e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[3283] = 1.670e-12; }
        
    if (Tgas>=10.0 && Tgas<300.0) { k[3284] = 1.670e-12 * exp(-1.700e+02 *
        invT); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[3291] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3292] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3293] = 1.670e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3294] = 6.670e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3295] = 1.670e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3296] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3297] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3298] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3299] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3300] = 1.670e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3301] = 6.670e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3302] = 1.670e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3303] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3304] = 5.000e-01 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3305] = 1.000e+00 * 1.230e-09 *
        (0.62e0 + 0.4767e0 * 3.330e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3306] = 1.430e-01 * 1.010e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3307] = 1.430e-01 * 1.010e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3308] = 1.430e-01 * 1.010e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3309] = 1.430e-01 * 1.010e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3310] = 1.430e-01 * 1.010e-09 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3311] = 4.620e-01 * 9.710e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3312] = 4.620e-01 * 9.710e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3313] = 4.620e-01 * 9.710e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3314] = 4.620e-01 * 9.710e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3315] = 4.620e-01 * 9.710e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3316] = 4.640e-01 * 9.390e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3317] = 4.640e-01 * 9.390e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3318] = 4.640e-01 * 9.390e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3319] = 4.640e-01 * 9.390e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3320] = 4.640e-01 * 9.390e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3321] = 6.940e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3322] = 2.310e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3323] = 4.630e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3324] = 4.630e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3325] = 6.940e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3326] = 2.310e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3327] = 4.630e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3328] = 4.630e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3329] = 2.310e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3330] = 6.940e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3331] = 4.630e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3332] = 4.630e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3333] = 2.310e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3334] = 6.940e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3335] = 9.250e-01 * 9.540e-10 *
        (0.62e0 + 0.4767e0 * 5.410e+00 * sqrt(3e2 * invT)); }
    ...
    if (Tgas>=10.0 && Tgas<800.0) { k[3372] = 1.020e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3373] = 2.030e-10 * exp(-2.070e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3374] = 3.050e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3375] = 2.550e-11 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3376] = 7.650e-11 * exp(-2.070e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3377] = 4.070e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3378] = 5.100e-11 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3379] = 5.100e-11 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3380] = 3.050e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3381] = 1.520e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3382] = 1.520e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3383] = 7.620e-11 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3384] = 2.290e-10 * exp(-2.070e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3385] = 3.050e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3386] = 5.100e-11 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3387] = 5.100e-11 * exp(-2.070e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3388] = 4.070e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3389] = 6.800e-11 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3390] = 3.400e-11 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3391] = 3.050e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3392] = 1.190e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3393] = 1.860e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3394] = 3.560e-10 * exp(-2.050e+04 *
        invT); }
        
    if (Tgas>=10.0 && Tgas<800.0) { k[3395] = 2.540e-10 * exp(-2.050e+04 *
        invT); }
